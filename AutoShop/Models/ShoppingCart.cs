...
namespace AutoShop.Models
{
    public class ShoppingCart
    {
        ...
        public void AddToCart(AutoPart autopart, int amount)
        {
            var shoppingCartItem = _appDbContext.ShoppingCartItems.SingleOrDefault(
                s => s.AutoPart.AutoPartsId == autopart.AutoPartsId && s.ShoppingCartId == ShoppingCartId);
        ...
        public int RemoveFromCart(AutoPart autopart)
        {
            var shoppingCartItem = _appDbContext.ShoppingCartItems.SingleOrDefault(
               s => s.AutoPart.AutoPartsId == autopart.AutoPartsId && s.ShoppingCartId == ShoppingCartId);
        ...
        public decimal GetShoppingCartTotal()
        {
            var total = _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartId)
                .Select(c => c.AutoPart.Price * c.Amount).Sum();
